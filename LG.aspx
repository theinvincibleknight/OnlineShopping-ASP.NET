<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LG.aspx.cs" Inherits="LG" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="~/LG/maxresdefaultt.jpg" 
        Width="1660px" />
    <p>
        &nbsp;</p>
    <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:ImageButton ID="ImageButton2" runat="server" 
        ImageUrl="~/LG/65E7_Medium_001 (1).jpg" style="margin-left: 50px" 
        Width="400px" onclick="ImageButton2_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label2" runat="server" Font-Bold="True" 
        Font-Names="Tw Cen MT Condensed" Font-Size="X-Large" Text="LG OLED 65E7"></asp:Label>
    &nbsp;&nbsp;
    <asp:ImageButton ID="ImageButton3" runat="server" 
        ImageUrl="~/LG/OLED65B6V2.jpg" style="margin-left: 50px" Width="400px" 
        onclick="ImageButton3_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label3" runat="server" Font-Bold="True" 
        Font-Names="Tw Cen MT Condensed" Font-Size="X-Large" Text="LG OLED 65B6V"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </form>
</body>
